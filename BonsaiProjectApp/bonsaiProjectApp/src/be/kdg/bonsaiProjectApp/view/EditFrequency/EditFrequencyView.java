...
public class EditFrequencyView extends BorderPane {
    ...
    public EditFrequencyView(UISettings uiSettings) {
    ...
    private void initialiseNodes() {
        ...
        this.nameLabel = new Label("Enter new frequency(how many seconds):");
