...
public class EditAlarmLevelPresenter {
    private MainModel model;
    private EditAlarmLevelView view;
    private UISettings uiSettings;

    public EditAlarmLevelPresenter(MainModel model, EditAlarmLevelView view, UISettings uiSettings) {
        this.model = model;
        this.view = view;
        ...
        view.getSaveButton().setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (playerName.isEmpty()) {
                    ...
                    model.sendString("4");
                    String alarmLevel = view.getNameField().getText();
                    model.sendString(alarmLevel);
                }
                updateView();
            }
        });
